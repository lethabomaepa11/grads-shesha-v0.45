      ...
      <div className={clsx("container", styles.heroGrid)}>
        <div className={styles.heroCopy}>
          <span className={styles.eyebrow}>
            Unofficial Shesha docs experience
          </span>
          ...
          <p className={styles.heroText}>
            Explore practical guides, front-end notes, and issue write-ups for
            the Shesha v0.45 learning track in a docs experience aligned to the
            live Shesha documentation site.
          </p>
      ...
      <div className="container">
        ...
        <div className={styles.linkGrid}>
          <Link className={styles.linkCard} to="/docs/intro">
            ...
            <span>
              Start with the platform overview and its low-code development
              model.
            </span>
          </Link>
          <Link
          ...
          >
            ...
            <span>
              Follow a concrete UI-focused customization example in the docs.
            </span>
          </Link>
          <Link className={styles.linkCard} to="/docs/shesha-issues/subform">
            ...
            <span>
              Review a documented issue and the expected handling around subform
              data.
            </span>
          </Link>
        </div>
